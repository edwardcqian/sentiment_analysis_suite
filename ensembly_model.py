...
print("Loading Data")
data = pd.read_csv('/mnt/66084616-7029-49cb-a245-3f8fad1c7542/work/climate/training/climate_dataset.csv')
...
file_path="/mnt/66084616-7029-49cb-a245-3f8fad1c7542/work/climate/weights_base.best.hdf5"
...
############################### GRU with Glove ###############################
# path to GloVe
EMBEDDING_FILE = '/mnt/66084616-7029-49cb-a245-3f8fad1c7542/Kaggle/glove.twitter.27B.200d.txt'
...
file_path="/mnt/66084616-7029-49cb-a245-3f8fad1c7542/work/climate/weights_lstm.best.hdf5"
checkpoint = ModelCheckpoint(file_path, monitor='val_loss', verbose=1, save_best_only=True, mode='min')
